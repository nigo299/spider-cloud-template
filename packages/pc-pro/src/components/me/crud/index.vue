...
type GetDataFunction = (params: any) => Promise<ApiResponse>
...
const props = defineProps({
   ...
   */
  getData: {
    type: Function as unknown as () => GetDataFunction,
    required: true,
  },
  /** 是否支持展开 */
  expand: Boolean,
...
const emit = defineEmits<{
  (e: 'update:queryItems', queryItems: QueryItems): void
  (e: 'onChecked', rowKeys: (string | number)[]): void
  (e: 'onDataChange', data: TableRow[]): void
}>()
...
async function handleReset(): Promise<void> {
  const queryItems: QueryItems = { ...props.queryItems }
