import { CUSTOM_DATA_PERMISSION_TYPE } from "@/enums";
...
export interface CustomDataPermission {
  code: string;
  id: string;
  name: string;
}
...
export interface IUserInfo {
  ...
  customDataPermissionType: CUSTOM_DATA_PERMISSION_TYPE;
  customDataPermissionIds: CustomDataPermission[];
}
